...
import { ExternalLink, Github, Calendar, Code, Bot, Globe, FileText } from 'lucide-react';

const Projects = () => {
  const projects = [
    {
      title: "Gemini API Chatbot with Voice Integration",
      date: "Aug 2025",
      github: "https://github.com/Aruncodings/gemini-chatbot",
      description: "A conversational AI chatbot with voice interaction capabilities and personalized user sessions.",
      achievements: [
        "Built a conversational chatbot using Gemini API integrated with Flask for web deployment.",
        "Implemented SQLite-based user authentication (login/signup) for personalized sessions and chat history tracking.",
        "Added voice-to-text support to allow users to interact with the chatbot hands-free, enhancing accessibility.",
      ],
      technologies: ["Python", "Flask", "Gemini API", "SQLite", "Voice Recognition", "NLP"],
      icon: <Bot className="h-6 w-6" />,
      featured: true
    },

    {
      title: "Web Scraper & Summarization Toolkit",
      date: "May 2025",
      github: "https://github.com/Aruncodings/web-scrapper-toolkit",
      description: "An intelligent web content extraction and summarization tool with NLP-powered analysis.",
      achievements: [
        "Built a Python-based tool to extract and summarize web content using NLP and sentiment analysis techniques.",
        "Implemented relevance filtering and keyword extraction to improve summarization clarity and reduce noise.",
        "Used BeautifulSoup, Newspaper3k, and NLTK to parse articles and generate concise summaries for research use."
      ],
      technologies: ["Python", "BeautifulSoup", "Newspaper3k", "NLTK", "NLP", "Sentiment Analysis"],
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Innovative solutions showcasing expertise in Python development, AI integration, and user-centered design.
          </p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`bg-gradient-to-br ${
                project.featured 
                  ? 'from-gray-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700 border-l-4 border-cyan-500' 
